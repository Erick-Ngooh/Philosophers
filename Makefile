...
#    Updated: 2022/06/08 12:38:46 by engooh           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

SRC = src/main.c src/routine.c src/init.c src/destroy.c src/join.c src/status.c
OBJ = ${SRC:%.c=%.o}
SRC_BONUS = src_bonus/exit_bonus.c src_bonus/kill_bonus.c src_bonus/open_bonus.c src_bonus/routine_bonus.c src_bonus/init_bonus.c  src_bonus/main_bonus.c src_bonus/parse_bonus.c  src_bonus/utils_bonus.c
